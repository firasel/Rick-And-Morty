        ...
        <div className="w-3/5 md:w-1/2 flex items-center justify-end relative">
          <div className="flex items-center searchBox relative">
            <div
              ...
              className="h-full rounded-l-full font-TTTravelsDemiBold text-xs md:text-base bg-customBlue text-white px-4 py-2 selectDiv cursor-pointer flex items-center gap-1 md:gap-2 border-[3px] border-customBlue"
            >
              {select}
              <img
