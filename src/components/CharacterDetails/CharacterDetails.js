            ...
            <div className="bg-gradient-to-br from-customBlue/70 to-customGreen/70 p-[1px] rounded-lg overflow-hidden">
              <div className="w-auto text-white bg-customBlack rounded-lg px-2 py-2 md:px-6 md:py-4 overflow-x-auto">
                <img
                  ...
                  alt="icon"
                />
                <span className="font-TTTravelsRegular text-sm md:text-xl">Status</span>
                <br />
            ...
            <div className="bg-gradient-to-br from-customBlue/70 to-customGreen/70 p-[1px] rounded-lg overflow-hidden">
              <div className="w-auto text-white bg-customBlack rounded-lg px-2 py-2 md:px-6 md:py-4 overflow-x-auto">
                <img
                  ...
                  alt="icon"
                />
                <span className="font-TTTravelsRegular text-sm md:text-xl">Species</span>
                <br />
                <span className="font-TTTravelsDemiBold text-[20px] md:text-[30px] 2xl:text-[40px] leading-none">
                  {species}
                </span>
            ...
            <div className="col-auto md:col-span-2 xl:col-auto bg-gradient-to-br from-customBlue/70 to-customGreen/70 p-[1px] rounded-lg overflow-hidden">
              <div className="w-auto text-white bg-customBlack rounded-lg px-2 py-2 md:px-6 md:py-4 overflow-x-auto">
                <img
                  ...
                  alt="icon"
                />
                <span className="font-TTTravelsRegular text-sm md:text-xl">Gender</span>
                <br />
                <span className="font-TTTravelsDemiBold text-[20px] md:text-[30px] 2xl:text-[40px] leading-none">
                  {gender}
                </span>
          ...
          <div className="bg-gradient-to-br from-customBlue/70 to-customGreen/70 p-[1px] rounded-lg overflow-hidden">
            <div className="w-auto text-white bg-customBlack rounded-lg px-2 py-2 md:px-6 md:py-4 overflow-x-auto">
              <img
                ...
                alt="icon"
              />
              <span className="font-TTTravelsRegular text-sm md:text-xl">Origin</span>
              <br />
          ...
          <div className="bg-gradient-to-br from-customBlue/70 to-customGreen/70 p-[1px] rounded-lg overflow-hidden">
            <div className="w-auto text-white bg-customBlack rounded-lg px-2 py-2 md:px-6 md:py-4 overflow-x-auto">
              <img
                ...
                alt="icon"
              />
              <span className="font-TTTravelsRegular text-sm md:text-xl">Episode(S)</span>
